# ===============================================================
#  PiQrypt v1.7.1 -- PiQrypt -- Startup
#  Usage : .\start_startup.ps1
# ===============================================================
...
# -- Features ----------------------------------------------------
Write-Host ""
Write-Host "  PiQrypt -- Startup" -ForegroundColor Cyan
Write-Host "  -----------------------------------------------" -ForegroundColor DarkGray
Write-Host "  Vigil     : Complet + workspace partage multi-utilisateurs" -ForegroundColor Green
Write-Host "  TrustGate : Manuel -- validation humaine" -ForegroundColor Green
...
Write-Host "  Workspace   : partage equipe (2-10 users)" -ForegroundColor DarkGray
Write-Host "  Agents max  : 50  --  Events/mois : 1 000 000" -ForegroundColor DarkGray
Write-Host ""
...
Write-Host "  PiQrypt -- Startup -- operationnel" -ForegroundColor Cyan
Write-Host "  ================================================" -ForegroundColor Cyan
