...
#!/usr/bin/env python3
"""
run_all.py — Lance tous les tests PiQrypt v1.8.4
================================================
...
def main():
    parser = argparse.ArgumentParser(description="PiQrypt v1.8.4 — Test runner")
    ...
    print(f"\n{BOLD}{CYAN}PiQrypt v1.8.4 — Test Suite{RESET}")
