...
def test_authority_verify(tmpdir):
    """Test: piqrypt authority verify — creates its own fixtures."""
    issuer_file, stmt_file, subject_id = test_authority_create(tmpdir)
