...
- Authentication via HMAC token (v1.7.1) — OIDC/SSO planned for v1.8.3
...
|-----------|--------|---------|
| `verify_tsa_token()` checks DER structure only — no CMS/PKCS7 verification | Forged TSA token could pass | v1.8.3 |
