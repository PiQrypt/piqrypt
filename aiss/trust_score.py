...
Hooks Sentinel (v1.8.1) :
    - get_a2c_risk() → None en v1.6.0, peuplé en v1.8.1
...
def compute_D_t(
    ...
    Hook A2C v1.8.1 : top_peer_ratio disponible pour
    ...
    return {
        ...
        "details": {
            ...
            "top_peer_ratio": round(top_ratio, 4),  # Hook A2C v1.8.1
...
def get_a2c_risk(agent_id: str) -> Optional[Dict[str, Any]]:
    ...
    v1.8.1 → score de risque relationnel complet
    """
    try:
