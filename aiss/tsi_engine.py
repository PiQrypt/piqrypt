...
Hook Sentinel v1.8.2 :
    ...
    En v1.6.0 : l'événement est loggé localement (prêt pour v1.8.2).
"""
...
def _emit_sentinel_event(
    ...
    """
    Hook pour Sentinel v1.8.2.

    v1.6.0 : log local uniquement.
    v1.8.2 : anomaly_monitor.record() sera appelé ici.

    L'interface est déjà prête — aucune modification nécessaire en v1.8.2,
    ...
    # Hook v1.8.2 — décommenter quand anomaly_monitor disponible :
    # try:
