...
Hook Sentinel v1.8.3 :
    ...
    En v1.6.0 : l'événement est loggé localement (prêt pour v1.8.3).
"""
...
def _emit_sentinel_event(
    ...
    """
    Hook pour Sentinel v1.8.3.

    v1.6.0 : log local uniquement.
    v1.8.3 : anomaly_monitor.record() sera appelé ici.

    L'interface est déjà prête — aucune modification nécessaire en v1.8.3,
    ...
    # Hook v1.8.3 — décommenter quand anomaly_monitor disponible :
    # try:
