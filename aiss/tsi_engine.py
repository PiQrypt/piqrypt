...
def _emit_sentinel_event(
    ...
    """
    Hook pour Sentinel v1.8.4.

    v1.6.0 : log local uniquement.
    v1.8.4 : anomaly_monitor.record() sera appelé ici.

    L'interface est déjà prête — aucune modification nécessaire en v1.8.4,
    ...
    # Hook v1.8.4 — décommenter quand anomaly_monitor disponible :
    # try:
