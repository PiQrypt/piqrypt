# ===============================================================
#  PiQrypt v1.7.1 -- PiQrypt -- Business
#  Usage : .\start_business.ps1
# ===============================================================
...
# -- Features ----------------------------------------------------
Write-Host ""
Write-Host "  PiQrypt -- Business" -ForegroundColor Magenta
Write-Host "  -----------------------------------------------" -ForegroundColor DarkGray
Write-Host "  Vigil     : Complet + SIEM + compliance AI Act / GDPR / MiFID II" -ForegroundColor Green
Write-Host "  TrustGate : Automatique -- politiques sans approbation humaine" -ForegroundColor Green
...
Write-Host "  TrustGate   : full auto (politiques driven)" -ForegroundColor DarkGray
Write-Host "  Compliance  : AI Act, GDPR Art.22, MiFID II" -ForegroundColor DarkGray
Write-Host "  Reseau      : accessible LAN (0.0.0.0)" -ForegroundColor DarkGray
Write-Host "  Agents max  : 500  --  Events/mois : 20 000 000" -ForegroundColor DarkGray
Write-Host ""
...
Write-Host "  PiQrypt -- Business -- operationnel" -ForegroundColor Magenta
Write-Host "  ================================================" -ForegroundColor Magenta
