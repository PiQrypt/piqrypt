...
#!/usr/bin/env python3
"""
PiQrypt v1.8.3 — Smoke Test / Validation Complète
==================================================
...
def print_summary():
    ...
    print("\n" + "=" * 65)
    print(f"{BOLD}BILAN — PiQrypt v1.8.3 Smoke Test{RESET}")
    print("=" * 65)
    blocs = {}
    ...
    print()
    if fail == 0:
        print(f"{GREEN}{BOLD}  ✅  Tous les checks passés — stack v1.8.3 opérationnel{RESET}")
    else:
...
def main():
    ...
    p = argparse.ArgumentParser(description="PiQrypt v1.8.3 — Smoke Test")
    ...
    print(f"\n{BOLD}{CYAN}PiQrypt v1.8.3 — Smoke Test / Validation Complète{RESET}")
