...
```python
{
  ...
  "audit_exports": 10,
  "keystore_created": 3,     # v1.8.1
  "agents_registered": 5     # v1.8.1
}
```
...
```python
{
  ...
  "avg_keystore_load_ms": 420.0    # v1.8.1 — scrypt expected ~400ms
}
```
