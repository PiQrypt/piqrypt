...
| §13.2 | Encrypted storage | ✅ | `aiss/key_store.py` | **v1.8.2** |
...
|---------|--------|--------|---------|
| **KeyStore — Encrypted Key Storage** | ✅ Complete | `aiss/key_store.py` | **v1.8.2** |
| scrypt N=2¹⁷ + AES-256-GCM | ✅ | `aiss/key_store.py` | v1.8.2 |
| Magic bytes validation (`PQKY`) | ✅ | `aiss/key_store.py` | v1.8.2 |
| RAM erasure (`_secure_erase`) | ✅ | `aiss/key_store.py` | v1.8.2 |
| Fixed file size (97 bytes) | ✅ | `aiss/key_store.py` | v1.8.2 |
| **Agent Registry** | ✅ Complete | `aiss/agent_registry.py` | **v1.8.2** |
| Class `AgentRegistry` (OO API) | ✅ | `aiss/agent_registry.py` | v1.8.2 |
| Path traversal protection | ✅ | `aiss/agent_registry.py` | v1.8.2 |
| Per-agent directory isolation | ✅ | `aiss/agent_registry.py` | v1.8.2 |
...
| Agent isolation via registry | ✅ | `aiss/memory.py` | v1.8.2 |
...
| **Migration** | ✅ Complete | `aiss/migration.py` | v1.8.2 |
| v1.6→v1.7 non-destructive | ✅ | `aiss/migration.py` | v1.8.2 |
| Automatic backup creation | ✅ | `aiss/migration.py` | v1.8.2 |
...
| Feature | Status | Module | Version |
|---------|--------|--------|---------|
| Policy engine (deterministic, 10-priority) | ✅ Complete | `trustgate/policy_engine.py` | v1.8.2 |
| Hash-chained governance journal | ✅ Complete | `trustgate/audit_journal.py` | v1.8.2 |
| Immutable policy versioning + SHA-256 | ✅ Complete | `trustgate/policy_versioning.py` | v1.8.2 |
| REQUIRE_HUMAN with TTL + auto-deny | ✅ Complete | `trustgate/decision.py` | v1.8.2 |
| Policy simulation (dry-run) | ✅ Complete | `trustgate/policy_engine.py` | v1.8.2 |
| 3 built-in compliance profiles | ✅ Complete | `trustgate/profiles/` | v1.8.2 |
| EU AI Act Art.14 human oversight | ✅ Complete | `trustgate/policy_engine.py` | v1.8.2 |

### AgentSession — Cross-Framework Co-Signed Sessions

| Feature | Status | Module | Version |
|---------|--------|--------|---------|
| N-agent session with pairwise handshakes | ✅ Complete | `bridges/session/__init__.py` | v1.8.2 |
| Same interaction_hash in both memories | ✅ Complete | `bridges/session/__init__.py` | v1.8.2 |
| Payload auto-hashing (RGPD by design) | ✅ Complete | `bridges/session/__init__.py` | v1.8.2 |
| Cross-framework audit export | ✅ Complete | `bridges/session/__init__.py` | v1.8.2 |

### Framework Bridges (9)

| Bridge | Status | Module | Version |
|--------|--------|--------|---------|
| LangChain | ✅ Complete | `bridges/langchain/` | v1.8.2 |
| CrewAI | ✅ Complete | `bridges/crewai/` | v1.8.2 |
| AutoGen | ✅ Complete | `bridges/autogen/` | v1.8.2 |
| OpenClaw | ✅ Complete | `bridges/openclaw/` | v1.8.2 |
| Session | ✅ Complete | `bridges/session/` | v1.8.2 |
| MCP | ✅ Complete | `bridges/mcp/` | v1.8.2 |
| Ollama | ✅ Complete | `bridges/ollama/` | v1.8.2 |
| ROS2 | ✅ Complete | `bridges/ros/` | v1.8.2 |
| RPi | ✅ Complete | `bridges/rpi/` | v1.8.2 |
