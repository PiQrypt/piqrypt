...
| §13.2 | Encrypted storage | ✅ | `aiss/key_store.py` | **v1.8.1** |
...
|---------|--------|--------|---------|
| **KeyStore — Encrypted Key Storage** | ✅ Complete | `aiss/key_store.py` | **v1.8.1** |
| scrypt N=2¹⁷ + AES-256-GCM | ✅ | `aiss/key_store.py` | v1.8.1 |
| Magic bytes validation (`PQKY`) | ✅ | `aiss/key_store.py` | v1.8.1 |
| RAM erasure (`_secure_erase`) | ✅ | `aiss/key_store.py` | v1.8.1 |
| Fixed file size (97 bytes) | ✅ | `aiss/key_store.py` | v1.8.1 |
| **Agent Registry** | ✅ Complete | `aiss/agent_registry.py` | **v1.8.1** |
| Class `AgentRegistry` (OO API) | ✅ | `aiss/agent_registry.py` | v1.8.1 |
| Path traversal protection | ✅ | `aiss/agent_registry.py` | v1.8.1 |
| Per-agent directory isolation | ✅ | `aiss/agent_registry.py` | v1.8.1 |
...
| Agent isolation via registry | ✅ | `aiss/memory.py` | v1.8.1 |
...
| **Migration** | ✅ Complete | `aiss/migration.py` | v1.8.1 |
| v1.6→v1.7 non-destructive | ✅ | `aiss/migration.py` | v1.8.1 |
| Automatic backup creation | ✅ | `aiss/migration.py` | v1.8.1 |
...
| Feature | Status | Module | Version |
|---------|--------|--------|---------|
| Policy engine (deterministic, 10-priority) | ✅ Complete | `trustgate/policy_engine.py` | v1.8.1 |
| Hash-chained governance journal | ✅ Complete | `trustgate/audit_journal.py` | v1.8.1 |
| Immutable policy versioning + SHA-256 | ✅ Complete | `trustgate/policy_versioning.py` | v1.8.1 |
| REQUIRE_HUMAN with TTL + auto-deny | ✅ Complete | `trustgate/decision.py` | v1.8.1 |
| Policy simulation (dry-run) | ✅ Complete | `trustgate/policy_engine.py` | v1.8.1 |
| 3 built-in compliance profiles | ✅ Complete | `trustgate/profiles/` | v1.8.1 |
| EU AI Act Art.14 human oversight | ✅ Complete | `trustgate/policy_engine.py` | v1.8.1 |

### AgentSession — Cross-Framework Co-Signed Sessions

| Feature | Status | Module | Version |
|---------|--------|--------|---------|
| N-agent session with pairwise handshakes | ✅ Complete | `bridges/session/__init__.py` | v1.8.1 |
| Same interaction_hash in both memories | ✅ Complete | `bridges/session/__init__.py` | v1.8.1 |
| Payload auto-hashing (RGPD by design) | ✅ Complete | `bridges/session/__init__.py` | v1.8.1 |
| Cross-framework audit export | ✅ Complete | `bridges/session/__init__.py` | v1.8.1 |

### Framework Bridges (9)

| Bridge | Status | Module | Version |
|--------|--------|--------|---------|
| LangChain | ✅ Complete | `bridges/langchain/` | v1.8.1 |
| CrewAI | ✅ Complete | `bridges/crewai/` | v1.8.1 |
| AutoGen | ✅ Complete | `bridges/autogen/` | v1.8.1 |
| OpenClaw | ✅ Complete | `bridges/openclaw/` | v1.8.1 |
| Session | ✅ Complete | `bridges/session/` | v1.8.1 |
| MCP | ✅ Complete | `bridges/mcp/` | v1.8.1 |
| Ollama | ✅ Complete | `bridges/ollama/` | v1.8.1 |
| ROS2 | ✅ Complete | `bridges/ros/` | v1.8.1 |
| RPi | ✅ Complete | `bridges/rpi/` | v1.8.1 |
